...
<body bgcolor='white'>
	...
	<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/front-end/member_review/forwarded" name="form1">
		<table>
			<tr>
				<td>訂餐編號:</td>
				<td><input type="TEXT" name="meal_order_no" size="45"
					value="<%=(member_reviewVO == null) ? "" : member_reviewVO.getMeal_order_no()%>" /></td>
			</tr>
			<tr>
				<td>評價內容:</td>
				<td><input type="TEXT" name="mem_review_con" size="45"
					value="<%=(member_reviewVO == null) ? "" : member_reviewVO.getMem_review_con()%>" /></td>
			</tr>
			<tr>
				<td>評價日期:</td>
